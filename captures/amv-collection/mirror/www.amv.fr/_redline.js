...
(function () {
  ...
  var INTRO = [
    ...
    { p: "Vous cherchez une assurance moto de collection à la hauteur de votre deux-roues ancien ? AMV, leader de l'assurance moto et scooter depuis 1974, a conçu l'offre AMV Légende pour couvrir les autos et motos anciennes. Couverture sur-mesure, garanties pensées pour les véhicules de collection, souscription rapide : vous construisez votre contrat selon chaque modèle et profitez de tarifs dégressifs selon l'âge et le nombre de véhicules à assurer." }
  ];

  var BODY = [
    { h2: "Pourquoi choisir AMV pour votre assurance moto de collection ?" },
    { p: "AMV est l'assureur spécialiste des deux-roues et des véhicules anciens. Plus d'1 million d'assurés lui font confiance, avec une note de 4,7/5 selon Avis Vérifiés. Plus de 300 conseillers basés en France vous accompagnent, et un interlocuteur dédié suit votre dossier en cas de sinistre. Un assureur généraliste connaît mal les besoins d'un motard collectionneur. AMV, lui, protège votre patrimoine roulant comme il le mérite, et vous gérez tout depuis l'espace client Mon Espace AMV." },
