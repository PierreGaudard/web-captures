var AGNES_EDITS = [
 {
  "ancre": "L'option Individuelle Pilote verse un capital en cas de décès ou d'invalidité permanente consécutifs à un accident, même responsable. Elle protège le conducteur, là où l'assurance de base couvre les tiers.",
  "old": "L’option Individuelle Pilote verse un capital en cas de décès ou d’invalidité permanente consécutifs à un accident, même responsable. Elle protège le conducteur, là où l’assurance de base couvre les tiers.",
 ...
 {
  "ancre": "Obtenir votre devis d'assurance moto Honda en ligne se fait en quelques étapes. Renseignez les informations sur votre Honda (modèle, puissance, année) et votre profil (expérience, bonus-malus, région) pour recevoir un tarif personnalisé en quelques minutes. Si le prix vous convient, vous souscrivez en quelques clics et recevez votre attestation par",
  "old": "Obtenir votre devis d’assurance moto Honda en ligne se fait en quelques étapes. Renseignez les informations sur votre Honda (modèle, puissance, année) et votre profil (expérience, bonus-malus, région) pour recevoir un tarif personnalisé en quelques minutes. Si le prix vous convient, vous souscrivez en quelques clics et recevez votre attestation par e-mail. Vous gérez ensuite votre contrat, vos garanties et vos sinistres depuis Mon Espace AMV, à tout moment.",
  "new": "Obtenir votre devis d’assurance moto Honda en ligne se fait en quelques étapes. Renseignez les informations sur votre Honda (modèle, puissance,date de mise en circulation et d'achat) et votre profil (expérience, bonus-malus, lieu de stationnement) pour recevoir un tarif personnalisé en quelques minutes. Si le prix vous convient, vous souscrivez en quelques clics et recevez votre attestation par e-mail. Vous gérez ensuite votre contrat, vos garanties et vos sinistres depuis Mon Espace AMV, à tout moment."
 },
 {
 ...
 {
  "ancre": "AMV propose la souscription simple et rapide en ligne vous permettant de bénéficier d'une couverture immédiate, sous réserve de certaines conditions. Plus besoin de vous déplacer en agence, quelques clics suffisent pour être assuré.",
  "old": "AMV propose la souscription simple et rapide en ligne vous permettant de bénéficier d'une couverture immédiate, sous réserve de certaines conditions. Plus besoin de vous déplacer en agence, quelques clics suffisent pour être assuré.",
  "new": "AMV propose la souscription simple et rapide en ligne vous permettant de bénéficier d'une couverture immédiate, sous réserve de certaines conditions. Pas besoin de vous déplacer en agence, quelques clics suffisent pour être assuré."
 },
 {
  ...
  "new": "En cas de sinistre, AMV met à votre disposition un service d'assistance réactif, disponible 24 heures sur 24 et 7 jours sur 7, si vous avez opté pour cette option. Vous pouvez ainsi compter sur une assistance même en bas de chez vous, qu'il s'agisse d'un accident, d'un vol ou d'une panne."
 },
 {
