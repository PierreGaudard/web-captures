var AGNES_EDITS = [
 {
  "ancre": "en cas d'invalidité permanente, ou à vos ayants droit en cas de décès, même lors d'un accident responsable. Cette garantie corporelle est précieuse au quotidien, la 125",
  "old": "Cette option vous verse un capital - jusqu’à 800 000 euros - en cas d’invalidité permanente, ou à vos ayants droit en cas de décès, même lors d’un accident responsable. Cette garantie corporelle est précieuse au quotidien, la 125 cm³ étant souvent utilisée en ville, où les risques de chutes sont plus fréquents.",
  "new": "Cette garantie corporelle est précieuse au quotidien, la 125 cm³ étant souvent utilisée en ville, où les risques de chutes sont plus fréquents."
 },
 {
 ...
 },
 {
  ...
  "old": "Après la première année, vous pouvez résilier à tout moment grâce à la loi Hamon, sans frais ni pénalité. Un conseiller AMV vous accompagne dans la démarche et peut effectuer les formalités auprès de votre ancien assureur, que ce soit une compagnie ou une mutuelle.",
  "new": "Après la première année, vous pouvez résilier à tout moment grâce à la loi Hamon, sans frais ni pénalité. Un conseiller AMV vous accompagne dans la démarche et effectue les formalités auprès de votre ancien assureur, que ce soit une compagnie ou une mutuelle."
 },
 {
 ...
 {
  "ancre": "Le choix de la formule d'assurance moto dépend entièrement de vos besoins spécifiques ainsi que de votre budget. Si vous possédez une moto récente, il est fortement recommandé de souscrire à une garantie dommages tous risques, cela vous permettra de couvrir les frais de réparation en cas d'accident responsable. AMV, en tant qu'assureur spécialisé dans l'assurance moto, propose différentes garanties et options adaptées à chaque profil. N'hésitez pas à réaliser un devis sur amv.fr ou nous contacter pour obtenir des informations détaillées sur les formules d'assurance moto proposées afin de trouver celle qui répond le mieux à vos besoins personnels",
  "old": "Le choix de la formule d'assurance moto dépend entièrement de vos besoins spécifiques ainsi que de votre budget. Si vous possédez une moto récente, il est fortement recommandé de souscrire à une garantie dommages tous risques, cela vous permettra de couvrir les frais de réparation en cas d'accident responsable. AMV, en tant qu'assureur spécialisé dans l'assurance moto, propose différentes garanties et options adaptées à chaque profil. N'hésitez pas à réaliser un devis sur amv.fr ou nous contacter pour obtenir des informations détaillées sur les formules d'assurance moto proposées afin de trouver celle qui répond le mieux à vos besoins personnels",
  "new": "Le choix de la formule d'assurance moto dépend entièrement de vos besoins spécifiques ainsi que de votre budget. Si vous possédez une moto récente, il est fortement recommandé de souscrire à une garantie tous risques, cela vous permettra de couvrir les frais de réparation en cas d'accident responsable. AMV, en tant qu'assureur spécialisé dans l'assurance moto, propose différentes garanties et options adaptées à chaque profil. N'hésitez pas à réaliser un devis sur amv.fr ou nous contacter pour obtenir des informations détaillées sur les formules d'assurance moto proposées afin de trouver celle qui répond le mieux à vos besoins personnels"
 },
 {
