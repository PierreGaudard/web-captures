// Redline AMV (page assurance quad) : ancien contenu barré rouge, nouveau vert.
// Contenu = version validée AMV (retours du 08/07/2026 intégrés).
(function () {
  var EDITS = [
    ...
    { mode: 'prependInside', scope: 'Consulter le détail', blockMatch: 'Formule 1',
      content: [
        { p: "La formule de base, au tiers, couvre votre responsabilité civile (dommages corporels illimités et dommages matériels jusqu'à 100 millions d'euros) mais inclut aussi une assistance juridique et la couverture de vos équipements de protection : casque jusqu'à 250 euros, gants jusqu'à 70 euros et gilet airbag jusqu'à 500 euros. Il s'agit de la solution la plus économique pour circuler en toute légalité, particulièrement adaptée aux quads de faible valeur ou utilisés ponctuellement dans le cadre d'une activité de loisir." }
      ] },
    ...
    { mode: 'prependInside', scope: 'Consulter le détail', blockMatch: 'Formule 4',
      content: [
        { p: "La formule la plus complète pour protéger votre quad. Elle couvre les dommages subis par votre véhicule, quelles que soient les circonstances. L'indemnisation est effectuée selon les conditions prévues au contrat, après déduction de la franchise applicable. Cette formule est particulièrement recommandée pour les quads neufs, récents ou financés à crédit. Vous profitez ainsi d'une protection optimale pour tous vos déplacements, sur route comme lors de vos activités de loisir." }
      ] },
    ...
    { mode: 'prependInside', scope: 'Consulter le détail', blockMatch: 'Assistance',
      content: [
        { p: "Assistance 24h/24 et 7j/7, sans franchise kilométrique, sur voie ouverte à la circulation : panne, accident, vol ou tentative de vol, crevaison, perte ou casse de clés, fourrière. Votre quad est dépanné ou remorqué, et vous êtes rapatrié avec votre passager, en France et dans la plupart des pays d'Europe." }
      ] },
    ...
    { mode: 'faqEdit', faqMatch: 'Des questions sur votre assurance',
      ...
      add: [
        ...
        { q: "Quel permis faut-il pour conduire un quad ?", content: [
          { p: "Le permis requis dépend de la catégorie du quad. Pour un quadricycle léger (50cc maximum), le permis AM (ex-BSR) est accessible dès 14 ans. Pour un quad lourd homologué route (quadricycle lourd), il faut le permis B1 (dès 16 ans) ou le permis B. Le permis moto seul ne permet pas de conduire un quad sur la voie publique." }
        ] },
        ...
        { q: "Comment assurer un buggy ou un SSV ?", content: [
          { p: "Pour assurer un buggy (ou SSV), la démarche est identique à celle d'un quad. AMV couvre votre buggy homologué avec le choix entre les quatre formules d'assurance quad, et votre buggy non homologué avec la formule dédiée, en usage privé. Renseignez les informations du buggy (modèle, cylindrée, numéro d'identification) pour obtenir votre devis en ligne." }
        ] }
      ] },
    ...
    { mode: 'renameHeader', pairs: [
      ...
      ["Des questions sur votre assurance", "Questions fréquentes sur l'assurance quad"],
    ] }
  ];
